...
<div>
    ...
    <el-table :data="seatlist">
        <el-table-column label="座位名" prop="Seatname" width="200" align="center"></el-table-column>
        <el-table-column label="座位价格" prop="price" width="200" align="center"></el-table-column>
    ...
    <el-dialog title="修改价格" width="20%" :visible.sync="dialogFormVisible" >
